...
const Music = () => {
    ...
    const mymusic =[{
        ...
        },
        {
            ...
            const filter=mymusicfilter.filter(music=>(
music.tag.indexOf(thisparam)>=0
    ...
    return (
        ...
        <div className="yt">
            ...
            <div className="yt__tags">
                    <button className="yt__buttontag" onClick={ () => {history.push(`../Music`);
                    window.scrollTo(
                        {
                            top: 150,
                            behavior: 'smooth',
                    ...
                    </button>
                    {
                        mytags.map(tag=>(
                            <>
                            <button className={tag.title===thisparam ? "yt__buttontag active" : "yt__buttontag"} key={tag.id} onClick={ () => {history.push(`${tag.title}`);
                        window.scrollTo(
                            {
                                top: 150,
                                behavior: 'smooth',
            ...
            {
                filter.map(music=>( <><div className="yt__container padding" key={music.Id}>
                ...
                <div className="yt__describe">{music.describe}</div>
                <span className="yt__tag">{music.tag.map(tags=>(<div className="tag" onClick={ () => {history.push(`${tags}`);
            window.scrollTo(
                {
                    top: 150,
                    behavior: 'smooth',
