    ...
    <div className="nav__paddingtop"></div>
        <nav className="nav padding">
         ...
         <ul className="nav__ul">
            ...
            <li><NavLink to="/SoundsEffects" exact>Sounds Effects</NavLink></li>
            <li><NavLink to="/Ambience" exact>Ambience</NavLink></li> 
...
export default Nav;
function deleteOff(): React.MouseEventHandler<HTMLImageElement> {
